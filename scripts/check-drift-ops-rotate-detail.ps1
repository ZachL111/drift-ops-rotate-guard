...
$repo = "drift-ops-rotate-guard"
$language = "JavaScript"
$category = "Automation"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/drift-ops-rotate-walkthrough.md")) {
